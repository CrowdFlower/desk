describe Desk::Client do
  ...
  context ".new" do
    before do
      @client = Desk::Client.new(:subdomain => "example", :consumer_key => 'CK', :consumer_secret => 'CS', :oauth_token => 'OT', :oauth_token_secret => 'OS', :support_email => "help@example.com")
    end

    describe ".create_interaction" do
      context "create a new interaction without specifying direction should default to inbound" do
        before do
          stub_post("interactions").
            to_return(:body => fixture("interaction_create.json"), :headers => {:content_type => "application/json; charset=utf-8"})
        end
    ...
    describe ".create_outbound_interaction" do
      ...
      context "without support_email defined" do
        ...
        before do
          @client_without_support_email = Desk::Client.new(:subdomain => "example", :consumer_key => 'CK', :consumer_secret => 'CS', :oauth_token => 'OT', :oauth_token_secret => 'OS')
        end
    ...
    describe ".interactions" do
      ...
      context "lookup" do
        ...
        before do
          stub_get("interactions").
            to_return(:body => fixture("interactions.json"), :headers => {:content_type => "application/json; charset=utf-8"})
        end
